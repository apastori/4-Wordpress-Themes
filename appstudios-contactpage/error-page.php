<?php //include 'customer-details.php'; ?>
...
body {
  background: white;
  background: -moz-linear-gradient(-45deg, white 0%, #f3f6ff 100%);
  background: -webkit-linear-gradient(-45deg, white 0%, #f3f6ff 100%);
...
<div class="wrapper red">
	...
	<h1>Whooops</h1>
	<p><?php echo "Error: " . mysqli_error($databaseConnection)?></p>
	
	<button><a href="http://appstudi-cp5034.wordpresstemporal.com/appstudios-temas/contact-page/">Volver</a></button>
</div> <!-- closing wrapper red -->
